...
export default function ProductDetails() {
  ...
  // Stock available after removing items already in cart
  const availableStock = product.stock - cartQuantity;

  // Stock shown while selecting the quantity
  const onStock = availableStock - count + 1;
    ...
    <div className="p-4 md:p-8">
      ...
      >
        ...
        >
          {/* Title & Description */}
          <div>
            <h1 className="font-bold text-xl md:text-3xl text-gray-900 mb-2">
              {product.title}
            </h1>
          ...
          >
            ...
            <div>
              ...
              <span className="text-xl md:text-3xl text-primary font-bold">
                ${totalPrice}
              </span>
            </div>
            ...
            >
              ...
              <span className="mx-4 text-base font-semibold text-gray-800">
                {count}
              </span>
